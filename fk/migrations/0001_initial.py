    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mahasiswa_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='fk.mahasiswa')),
                ('tendik_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='fk.tendik')),
            ],
        ),
    ]
